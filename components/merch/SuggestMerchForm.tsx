                    ...
                    <div className="flex flex-wrap items-center gap-2 md:gap-6">
                        <div className="flex flex-col gap-1 md:gap-2 w-full md:w-5/12 flex-1 text-base min-w-[265px] max-w-[450px] text-[#171A33]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <select
                                    className="p-1 md:p-2 rounded-lg bg-white w-4/12"
                                    id="type"
                                    name="type"
                                    value={selectedType}
                                    onChange={handleDropdownChange}
                        ...
                        <div className="w-full md:w-8/12 bg-[#D8DCDF] flex-1 h-[190px] md:h-[500px] flex items-center justify-center overflow-hidden relative rounded-lg min-w-[255px]">
                            ...
                            <label
                                htmlFor="file-upload"
                                className="w-full h-full flex flex-col items-center justify-center cursor-pointer text-[#525252]"
                            >
                                <FaCloudArrowUp
                                    color="#525252"
                                    className="w-16 h-16 md:w-32 md:h-32 lg:w-32 lg:h-32"
                                />
                                <span className="text-2xl font-bold font-vietnam tracking-widest">
                                    UPLOAD FILE
                                </span>
                            </label>
                        </div>
