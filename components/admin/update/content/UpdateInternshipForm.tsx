...
export const UpdateInternshipForm = ({
    ...
    useEffect(() => {
        ...
        const fetchEvent = async () => {
            try {
                const internship = await apiClient.get(
                    `/cms/internships/${id}/`
                )
                console.log('Fetched scholarship:', internship)

                setFormData({
                    title: internship.title || '',
                    benefits: internship.benefits || '',
                    deadline: internship.deadline || '',
                    opening_date: internship.opening_date || '',
                    organization: internship.organization || '',
                    requirements: internship.requirements || '',
                    external_url: internship.external_url || null,
                    image_url: internship.image_url || null,
                    article: internship.article || null,
                })
