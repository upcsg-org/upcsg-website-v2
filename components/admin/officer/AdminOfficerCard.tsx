    ...
    return (
        ...
        >
            <div className="absolute top-2 right-2 flex gap-2 z-10">
                <button
                    onClick={onEdit}
                    className="bg-csg-blue-300 hover:bg-csg-blue-400 text-black p-1 md:p-2 rounded-full shadow-lg shadow-black"
                    title="Edit"
                >
                ...
                <button
                    onClick={onDelete}
                    className="bg-csg-red-100 hover:bg-csg-red-200 text-black p-1 md:p-2 rounded-full"
                    title="Delete"
                >
